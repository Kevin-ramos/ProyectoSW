    ...
    return (
        <Layout title={"PRUEBAS DE ACEPTACIÓN DEL SISTEMA"}>
            <div style={{backgroundColor: "white", textAlign: "center"}}>
                ...
                <p>El proceso de incorporación de nuevas aplicaciones actualizaciones o nuevas versiones de software
                    debe estar sujeto a un proceso de aceptación donde se le realicen las pruebas funcionales y de
                    seguridad planificadas con el fin de garantizar la calidad y fiabilidad.</p>
