    ...
    return (
        <Layout title={"PRUEBAS DE SEGURIDAD DEL SISTEMA"}>
            <div style={{backgroundColor: "white", textAlign: "center"}}>
                ...
                <p>Los requisitos para la seguridad de un sistema software deben ser probados como si se tratase de una
                    funcionalidad más del software. Para ello debería implementarse un plan de pruebas documentado que
                    nos ayudará a evaluar la seguridad de nuestro sistema</p>
