    ...
    return (
        <Layout title={"PRINCIPIOS DE LA INGENIERÍA DE SISTEMAS SEGUROS"}>
            <div style={{backgroundColor: "white", textAlign: "center"}}>
                ...
                <p>Se deberían establecer, documentar, mantener y aplicar los principios para la ingeniería de sistemas
                    seguros para cualquier labor de implementación del sistema de información.</p>
