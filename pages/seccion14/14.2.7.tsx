    ...
    return (
        <Layout title={"DESARROLLO SUBCONTRATADO"}>
            <div style={{backgroundColor: "white", textAlign: "center"}}>
                ...
                <p>Para la subcontratación de desarrollos de Software deberíamos tener en cuenta que la organización
                    deberá supervisar y monitorear las actividades del desarrollo externalizado del sistema </p>
