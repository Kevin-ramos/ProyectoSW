    ...
    return (
        <Layout title={"RESTRICCIONES A LOS CAMBIOS EN LOS PAQUETES DE SOFTWARE"}>
            <div style={{backgroundColor: "white", textAlign: "center"}}>
                ...
                <p>Se deberían desalentar las modificaciones a los paquetes de software, limitándose a los cambios
                    necesarios y todos los cambios se deberían controlar estrictamente </p>
